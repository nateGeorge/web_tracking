...
http.createServer(function (request, response) {
  if(url.parse(request.url).pathname == '/') {
    ...
    //response.writeHead(301, {Location: 'localhost:3001/track.html'});
    //response.writeHead(200, {'Connection': 'keep-alive', 'Transfer-Encoding': 'chunked'});
    //var rs = fs.createReadStream('./track.html', 'binary').pipe(response);
  }
